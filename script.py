...
"""EXE HERE"""
exe = r"rclone\rclone.exe"
"""END EXE"""



parascmd = eval(open("CommandParas.txt").read())
...
##            self.ConfigButtons.append(self.ConfigSection)
    ...
    def EXEStart(self):
        ...
        CLIProcess(self.MainButtons, *self.currentcommandlist2)
    ...
    def AddButtonToTab(self,Tab,command):
        ...
        self.TestCommand = tkinter.Button(self.MainButtons, text = 'Test', width = 16,command = lambda: self.EXEStart())
